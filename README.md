...
| 07 | [A 3.5 inch SPI display as a DRM panel with touch](projects/07-lcd35-drm) | Raspberry Pi 3B+ | DRM/KMS tiny drivers, input subsystem, fbcon | **Software complete**: overlay, kernel fragment, three programs and two test suites; no board work yet |
